...
public class PostClass extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView userNameText = customView.findViewById(R.id.txw_username);
        TextView commentText = customView.findViewById(R.id.txw_aciklama);
        ImageView imageView = customView.findViewById(R.id.img_paylasilanfotograf);
